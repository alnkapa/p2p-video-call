...
class VideoContainer extends HTMLElement {
  ...
  async setupEventListeners() {
    ...
    //     this.dispatchEvent(
    //       new CustomEvent("toggle-video", { bubbles: true, composed: true })
    //     );
    //   } else if (event.target.matches("#toggle-audio")) {
    //     this.dispatchEvent(
    //       new CustomEvent("toggle-audio", { bubbles: true, composed: true })
    //     );
    //   } else if (event.target.matches("#switch-camera")) {
    //     this.dispatchEvent(
    //       new CustomEvent("switch-camera", { bubbles: true, composed: true })
    //     );
    //   } else if (event.target.matches("#end-call")) {
    //     this.dispatchEvent(
    //       new CustomEvent("end-call", { bubbles: true, composed: true })
    //     );
    //   }
    // });
